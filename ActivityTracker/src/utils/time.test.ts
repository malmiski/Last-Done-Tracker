...
describe('formatTimeSince', () => {
  ...
  it('should return seconds ago for times less than a minute', () => {
    ...
    expect(formatTimeSince(fiveSecondsAgo, now)).toBe('5 seconds ago');
  });
  ...
  it('should return minutes and seconds ago for times less than an hour', () => {
    ...
    expect(formatTimeSince(oneMinuteFiveSecondsAgo, now)).toBe('1 minute 5 seconds ago');
  });
  ...
  it('should return hours and minutes ago for times less than a day', () => {
    ...
    expect(formatTimeSince(fourHoursFiveMinutesAgo, now)).toBe('4 hours 5 minutes ago');
  });
  ...
  it('should return days and hours ago for times less than a month', () => {
    ...
    expect(formatTimeSince(eightDaysFiveHoursAgo, now)).toBe('8 days 5 hours ago');
  });
  ...
  it('should return months and days ago for times less than a year', () => {
    ...
    expect(formatTimeSince(twoMonthsThreeDaysAgo, now)).toBe('2 months 3 days ago');
  });
  ...
  it('should return years and months ago for times more than a year', () => {
    ...
    expect(formatTimeSince(oneYearTwoMonthsAgo, now)).toBe('1 year 2 months ago');
  });
});